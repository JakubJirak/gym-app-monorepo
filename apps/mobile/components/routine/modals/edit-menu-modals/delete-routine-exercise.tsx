...
type DeleteRoutineExerciseProps = {
	visible: boolean;
...
export default function DeleteRoutineExerciseModal({
	visible,
	setVisible,
	routineExerciseId,
	closeParent,
			...
			<View className="h-[33%] rounded-t-xl bg-darker p-4">
				...
				<View className="flex-1 items-center justify-between">
					...
					<Text className="text-center text-muted">
						Tato akce se nedá navrátit. Navždy smaže cvik z této rutiny včetně všech poznámek.
					</Text>
