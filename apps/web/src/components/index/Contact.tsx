...
const Contact = () => (
	<section
		...
		id="kontakt"
	>
		<div className="mx-auto flex max-w-[75%] flex-col xl:max-w-1/2">
			<p className="w-full font-light text-base leading-relaxed md:text-xl lg:text-2xl/9">
				Repozitář této aplikace je dostupný na GitHubu. Pokud najdete v aplikaci nějaké chyby, můžete
				založit issue. Pokud vás napadne způsob, jak aplikaci vylepšit nebo nová funkcionalita, obraťte
				se na mě.
			</p>
