...
const Download = () => (
	<section className="w-full bg-background px-6 pb-20 md:px-20 md:pb-32 lg:pb-42 xl:px-64">
		<h3
			className="mb-6 w-full pt-20 font-bold text-2xl leading-tight md:mb-8 md:w-3/4 md:pt-32 md:text-4xl lg:pt-42 lg:text-5xl/14 xl:w-1/2"
			id="download"
		>
