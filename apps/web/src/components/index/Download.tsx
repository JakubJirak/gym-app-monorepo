...
const Download = () => (
	<section className="w-full bg-background px-6 pb-20 md:px-20 md:pb-32 lg:px-32 lg:pb-42" id="download">
		<div className="mx-auto flex max-w-[75%] flex-col items-center xl:max-w-1/2">
			...
			<p className="font mb-12 w-full font-light text-base leading-relaxed md:mb-16 md:text-xl lg:mb-24 lg:text-2xl/9">
