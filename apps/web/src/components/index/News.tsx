			...
			<div className="">
				...
				<div className="ml-8">
					<div className="my-4 md:my-5">
						...
						<ul className="space-y-2 pl-1 md:space-y-2.5">
							<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
								Nová verze mobilní aplikace s vylepšenými barvami, animacemi a
								stabilitou.
							</li>
						</ul>
					</div>
					...
					<div className="my-4 md:my-5">
						...
						<ul className="space-y-2 pl-1 md:space-y-2.5">
							<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
								Sdílení tréninků - Přidání možnosti sdílet trénink s ostatními lidmi bez
								nutnosti mít účet
							</li>
						</ul>
					</div>
					...
					<div>
						...
						<ul className="space-y-2 pl-1 md:space-y-2.5">
							<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
								Oprava stability a funkčnosti webové apklikace.
							</li>
						</ul>
					</div>
				</div>
