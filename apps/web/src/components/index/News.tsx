	...
	>
		...
		<div className="">
			...
			<div className="my-4 md:my-5">
				<p className="mb-2 font-semibold text-base uppercase md:mb-3 md:text-lg">Hlavní novinky</p>
				<ul className="space-y-2 pl-1 md:space-y-2.5">
					<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
						Rutiny - uživatel si vytvoří rutinu, podle které se dá vytvořit trénink už s předem
						přidanými cviky
					</li>
					<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
						Kategorie - každý trénink a rutina má nyní svoji kategorii, podle které je můžete
						filtrovat
					</li>
					<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
					...
					<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
						Statistiky - v mobilní aplikaci se nachází nový radio graf pro zobrazení četnosti
						tréninku svalových skupin
					</li>
				</ul>
			</div>
			<div>
				...
				<ul className="space-y-2 pl-1 md:space-y-2.5">
					<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
						Názvy tréninků - tréninky nemají nyní názvy, ten vyměnil jeho datum. Můžete si ale
						přidat ke každému tréninku poznámku
					</li>
					<li className="relative pl-6 text-foreground/90 text-sm leading-relaxed before:absolute before:top-[0.6em] before:left-0 before:size-1.5 before:rounded-full before:bg-primary md:text-base">
